...
public class Change_Cart extends HttpServlet {
    ...
    */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (String.valueOf(request.getParameter("change_cart")).equals("Update cart")) {
            
            Control_Change_Shopping_Cart_Items.use_connection = use_open_connection;
            Control_Change_Shopping_Cart_Items.row_id = String.valueOf(request.getParameter("row_id")).split(",");
            ...
            Control_Change_Shopping_Cart_Items.change_cart = String.valueOf(request.getParameter("change_cart"));
            
            out.println(Control_Change_Shopping_Cart_Items.control_change_cart());
        }
    }
