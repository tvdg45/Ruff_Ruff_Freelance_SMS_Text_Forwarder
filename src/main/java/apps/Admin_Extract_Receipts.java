...
public class Admin_Extract_Receipts extends HttpServlet {
    ...
    */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("{\"receipts\": ");
        out.println(Control_Change_Shopping_Cart_Items.control_search_receipts() + ",");
        out.println(" \"items_sold\": ");
        out.println(Control_Change_Shopping_Cart_Items.control_search_items_sold() + "}");
    }
