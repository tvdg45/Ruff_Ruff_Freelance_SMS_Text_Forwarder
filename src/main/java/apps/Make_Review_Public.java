...
public class Make_Review_Public extends HttpServlet {
    ...
    */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (String.valueOf(request.getParameter("make_review_public")).equals("Show")) {
            ...
            Control_Change_Reviews.make_review_public = String.valueOf(request.getParameter("make_review_public"));
            
            out.println(Control_Change_Reviews.control_make_review_public());
        }
    }
