...
public class Clear_All_Carts extends HttpServlet {
    ...
    */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (String.valueOf(request.getParameter("clear_all_carts")).equals("Clear all carts")) {
            ...
            Control_Change_Shopping_Cart_Items.clear_all_carts = String.valueOf(request.getParameter("clear_all_carts"));
            
            out.println(Control_Change_Shopping_Cart_Items.control_clear_all_carts());
        }
    }
