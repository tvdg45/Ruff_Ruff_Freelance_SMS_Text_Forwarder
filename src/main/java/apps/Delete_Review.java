...
public class Delete_Review extends HttpServlet {
    ...
    */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (String.valueOf(request.getParameter("delete_review")).equals("Delete")) {
            ...
            Control_Change_Reviews.delete_review = String.valueOf(request.getParameter("delete_review"));
            
            out.println(Control_Change_Reviews.control_delete_review());
        }
    }
