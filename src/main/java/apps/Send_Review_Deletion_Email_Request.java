...
public class Send_Review_Deletion_Email_Request extends HttpServlet {
    ...
    */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (String.valueOf(request.getParameter("send_review_deletion_email_request")).equals("Delete")) {
            ...
            Control_Change_Reviews.send_review_deletion_email_request = String.valueOf(request.getParameter("send_review_deletion_email_request"));
            
            out.println(Control_Change_Reviews.control_send_review_deletion_email_request());
        }
    }
