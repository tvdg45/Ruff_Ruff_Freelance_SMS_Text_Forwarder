...
@RequestMapping("/send-review-deletion-email-request")
public class Send_Review_Deletion_Email_Request {
    ...
    String home(
		...
		Control_Change_Reviews.send_review_deletion_email_request = send_review_deletion_email_request;
