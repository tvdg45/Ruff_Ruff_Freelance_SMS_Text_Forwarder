...
public class Enable_Review_Editing extends HttpServlet {
    ...
    */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (String.valueOf(request.getParameter("enable_review_editing")).equals("Enable")) {
            ...
            Control_Change_Reviews.enable_review_editing = String.valueOf(request.getParameter("enable_review_editing"));
            
            out.println(Control_Change_Reviews.control_enable_review_editing());
        }
    }
