...
public class Delete_From_Cart extends HttpServlet {
    ...
    */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (String.valueOf(request.getParameter("delete_from_cart")).equals("Delete item(s)")) {
            ...
            Control_Change_Shopping_Cart_Items.delete_from_cart = String.valueOf(request.getParameter("delete_from_cart"));
            
            out.println(Control_Change_Shopping_Cart_Items.control_delete_from_cart());
        }
    }
