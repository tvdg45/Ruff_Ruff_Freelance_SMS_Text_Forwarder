...
public class Change_Review extends HttpServlet {
    ...
    */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (String.valueOf(request.getParameter("change_review")).equals("Submit")) {
            ...
            Control_Change_Reviews.change_review = String.valueOf(request.getParameter("change_review"));
            
            out.println(Control_Change_Reviews.control_change_review());
        }
    }
